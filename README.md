...
I am usnig the newer AMOLED 2.06" Display, so while I expect the process is similar using the 1.28" Round display, I can not confirm.  
...
2. Decide what is needed for each of those steps.
   - Program two sequences in Maestro 12,  one to open arms, one to close.  And keep track of their numbers.  (For my Example,  Sequence 3 will OPEN, Sequence 4 will CLOSE)
   - Program two sequences in Maestro 24,  one to open the panels in steps,  the other to close.  Keep track of their numbers.  (For my Example,  Sequence 5 will OPEN, Sequence 6 will CLOSE)
...
3. Start working on the parts for Step 2, one at a time.   For example,  connect to the Maestro 12, and use the Maestro Control program the first sequence to open the Utility Arms, and then program the second sequence to close the Utlity Arm, saving them to your Maestro, and keeping note of their Sequence Number.  Then do the same with the Maestro 24 and the sequences for the Pie Pieces, again, saving to the Maestro 24 and keeping track of their sequence numbers
