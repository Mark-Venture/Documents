...
Trigger animations using either `:` or `=` as delimiters. Chained arguments and custom durations are fully supported.
A leading colon (`:`) is automatically stripped from the command if sent by external hardware/controllers.
